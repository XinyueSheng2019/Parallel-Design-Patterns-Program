...
int willGiveBirth(float avg_pop, long * state) {
	float probability=300.0; // Decrease this to make more likely, increase less likely
...
int willCatchDisease(float avg_inf_level, long * state) {
	float probability=500.0; // Decrease this to make more likely, increase less likely
